      ...
      <div className="ml-16 p-8">
        ...
        {activeTab === "users" && (
          <div className="bg-slate-900 rounded-xl p-6 border border-slate-700">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold text-slate-100">Manage Library Members</h2>
              <button
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-slate-700">
                <thead>
                  <tr className="text-left">
                    <th className="pb-4 text-slate-300 font-medium">Name</th>
                    <th className="pb-4 text-slate-300 font-medium">Email</th>
                    <th className="pb-4 text-slate-300 font-medium">Role</th>
                    <th className="pb-4 text-slate-300 font-medium">Joined Date</th>
                ...
                <tbody className="divide-y divide-slate-700">
                  {users.map((user) => (
                    <tr key={user.id} className="hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="py-4 text-slate-200">{user.email}</td>
                      <td className="py-4">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          user.role === 'admin' 
                      ...
                      <td className="py-4 text-slate-200">{formatDate(user.created_at)}</td>
                      <td className="py-4">
                        <div className="flex space-x-2">
                          <button
                            onClick={() => {
              ...
              {users.length === 0 && (
                <div className="text-center py-8">
                  <div className="text-slate-400 mb-2">No members found</div>
                  <p className="text-sm text-slate-500">Add a new member to get started</p>
                </div>
              )}
            </div>
          </div>
